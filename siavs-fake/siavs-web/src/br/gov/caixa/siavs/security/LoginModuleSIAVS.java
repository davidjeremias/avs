...
public class LoginModuleSIAVS extends AbstractLoginModule {
	...
	protected Principal carregarUsuario(String matricula) throws Exception {
		...
		matricula = "C077777";
		//matricula = "C072486"; // Elara
		// matricula = "C128134"; // Waleska, GestorPV
		// matricula = "C084057"; // Márcio, GestorPV
		// matricula = "C072486";//GestorPV, agencia
		// matricula = "C035510";//GestorPV, não agencia
